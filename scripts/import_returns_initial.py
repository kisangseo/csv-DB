...
from returns import is_hard_copy_return_type, payload_from_export_row, upsert_return
...
def upload_and_import(container, conn, row, pdf_filename, pdf_bytes):
    ...
    if is_hard_copy_return_type(payload.get("document_type")):
...
def main():
    ...
    if args.source_dir:
        ...
        if args.hard_copy_xlsx and args.hard_copy_zip:
