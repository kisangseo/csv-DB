...
print("=== START extract_jail_pop.py ===")
...
for blob in container_client.list_blobs():
    ...
    # Only Baltimore jail PDFs
    if not name_lower.endswith(".pdf"):
        print("  SKIP: Not a PDF")
        continue

    if "baltimorejailpopulation" not in name_lower:
        print("  SKIP: PDF but not Baltimore jail pop")
        continue
...
if found_any and not processed_any:
    print("ERROR: Blobs exist, but none matched baltimorejailpopulation PDFs.")

if processed_any:
    print("SUCCESS: PDFs processed and CSVs uploaded.")
